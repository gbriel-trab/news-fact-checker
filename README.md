...
* **301 fatos confirmados por 2+ veículos independentes**, de 1.395
  fatos distintos
* 754 testes, todos sem rede; a camada de verificação — onde erro é
  silencioso — é a mais coberta
* Gabarito de regressão dos prompts: 44 casos do separador (ficam fora do
  repositório, porque reproduzem texto de post) e 37 do juiz. Última
  rodada completa em 08/09/2026, 3 passadas, US$ 3,80: zero regressões,
  depois de a bateria mostrar que a regra nova de fala de terceiro tinha
  trocado o veredito de um caso que passava desde 03/09
